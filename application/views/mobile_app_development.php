<div class="title-page position-relative pt-120 pb-120">
    <div class="container">
        <div class="row mt-60 ">
            ...
            <div class="col-md-6">
                <figure><img src="<?php echo base_url(); ?>assets/images/mobile-app-development.png" alt="" class="d-table ml-auto"></figure>
            </div>
        </div>
    </div>
</div>
<div class="ios-app-development py-120">
    <div class="container">
        <div class="row align-items-center">
            ...
            <div class="col-md-6">
                <img src="<?php echo base_url(); ?>assets/images/ios/ios.png" alt="" class="d-table ml-auto mr-auto"></figure>
            </div>
        </div>
    </div>
</div>
<section class="web-development py-120 ">
    <div class="container">
        <div class="row align-items-center">
            <div class="col-md-6">
                <img src="<?php echo base_url(); ?>assets/images/ios/android.png" alt="" class="d-table mr-auto"></figure>
            </div>
