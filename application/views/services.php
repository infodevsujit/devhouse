...
<section class="web-development py-120 ">
    <div class="container">
        <div class="row align-items-center">
        <div class="col-md-6">
                <figure><img src="<?php echo base_url(); ?>assets/images/ios/android.png" alt="Android app development" class="d-table mr-auto"></figure>
            </div>
            <div class="col-md-6 pl-5">
                <h2 class="line fz28 fw-6 text-uppercase color mb-18 ">Android app development</h2>
